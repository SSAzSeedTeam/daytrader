...
<%@ page
    import="java.util.Collection,java.util.Iterator,java.math.BigDecimal,com.ofss.daytrader.core.direct.*,com.ofss.daytrader.entities.*,com.ofss.daytrader.utils.*"
...
<jsp:useBean id="accountProfileData"
    type="com.ofss.daytrader.entities.AccountProfileDataBean"
    scope="request" />
...
<TABLE width="620">
    <TBODY>
        <TR>
            ...
            int count = 0;
            while (it.hasNext()) {
                if ((showAllOrders == false) && (count++ >= 50))
                    break;
