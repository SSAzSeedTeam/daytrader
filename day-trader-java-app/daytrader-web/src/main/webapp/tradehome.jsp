...
<%@ page
    import="java.util.Collection, java.util.Iterator, java.math.BigDecimal, com.ofss.daytrader.entities.*, com.ofss.daytrader.core.direct.*"
    session="true" isThreadSafe="true" isErrorPage="false"%>
<jsp:useBean id="results" scope="request" type="java.lang.String" />
<jsp:useBean id="accountData"
    type="com.ofss.daytrader.entities.AccountDataBean"
    scope="request" />
...
<TABLE height="54">
    <TBODY>
        ...
        <TR align="left">
            ...
            <TD><B><A href="app?action=quotes&amp;symbols=ACGL,ALPN,BKSC,ATRC,BBIG">Quotes/Trade</A></B></TD>
                ...
                <TBODY>
                    <TR>
                        ...
                        <INPUT size="20" type="text" name="symbols"
                            value="ACGL,ALPN,BKSC,ATRC,BBIG"></FORM>
                        </TD>
                    </TR>
                </TBODY>
            </TABLE>
