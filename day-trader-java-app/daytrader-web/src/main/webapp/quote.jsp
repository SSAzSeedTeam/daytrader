...
<%@ page import="java.util.Collection, java.util.Iterator, com.ofss.daytrader.core.direct.*, com.ofss.daytrader.entities.*, com.ofss.daytrader.utils.*" session="true" isThreadSafe="true" isErrorPage="false"%>
            ...
            <TABLE width="100%" style="font-size: smaller">
                <TBODY>
                    <TR>
                        ...
                        <TD align="right"><FORM><INPUT type="submit" name="action" value="quotes"> <INPUT size="20" type="text" name="symbols" value=""></FORM></TD>
                    </TR>
                </TBODY>
            </TABLE>
            </TD>
