...
// Broke the coupling with entities; entities refer to utilities not the other way around 
// If I could not have broken this coupling then I would have moved this class into the entities;
// It necessary I would have moved all utility classes into the entities package and then removed
...
// Broke the dependency between this utility and the entities (see above)
// 
