...
set DAYTRADER_APP_ARTIFACTID=daytrader-gatewayapp
set DAYTRADER_WAR_ARTIFACTID=daytrader-gateway
...
set SERVER_PORT=2443
set SERVER_PORT_HTTPS=2443

@ECHO OFF
echo set service routes
set DAYTRADER_ACCOUNTS_SERVICE=http://localhost:1443
set DAYTRADER_GATEWAY_SERVICE=http://localhost:2443
set DAYTRADER_PORTFOLIOS_SERVICE=http://localhost:3443
set DAYTRADER_QUOTES_SERVICE=http://localhost:4443
