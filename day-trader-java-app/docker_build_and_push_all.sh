...
cd daytrader-onprem-exchange-rate    ; chmod 755 *sh ; dos2unix *.sh ; sudo ./docker-build.sh ; cd ..
...
sudo docker tag daytrader-onprem-exchange-rate:0     tnshibu/daytrader-onprem-exchange-rate:0
