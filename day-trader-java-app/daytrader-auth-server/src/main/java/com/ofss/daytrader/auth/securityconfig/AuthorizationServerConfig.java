 ...
 * org.springframework.security.oauth2.core.oidc.IdTokenClaimNames; import
 ...
 * CLIENT_SECRET = "devglan-secret"; static final String GRANT_TYPE_PASSWORD =
 * "password"; static final String AUTHORIZATION_CODE = "authorization_code";
 * static final String REFRESH_TOKEN = "refresh_token"; static final String
 * IMPLICIT = "implicit"; static final String SCOPE_READ = "read"; static final
 * String SCOPE_WRITE = "write"; static final String TRUST = "trust"; static
 * final int ACCESS_TOKEN_VALIDITY_SECONDS = 2*60*60; static final int
 ...
 * converter = new JwtAccessTokenConverter(); converter.setSigningKey(secret);
 * return converter; }
 * 
 * @Bean public TokenStore tokenStore() { System.out.println("tokenStore");
 ...
 * throws Exception { configurer .inMemory() .withClient(CLIEN_ID)
 * .secret(CLIENT_SECRET) .authorizedGrantTypes(GRANT_TYPE_PASSWORD,
 * AUTHORIZATION_CODE, REFRESH_TOKEN, IMPLICIT ) .scopes(SCOPE_READ,
 * SCOPE_WRITE, TRUST)
 * .accessTokenValiditySeconds(ACCESS_TOKEN_VALIDITY_SECONDS).
 * refreshTokenValiditySeconds(FREFRESH_TOKEN_VALIDITY_SECONDS); }
 * 
 * private ClientRegistration googleClientRegistration() { return
 * ClientRegistration.withRegistrationId("auth-service-oauth-jwt")
 * .clientId(CLIEN_ID) .clientSecret(CLIENT_SECRET)
