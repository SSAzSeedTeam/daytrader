...
//    }
    ...
    //
    // Profile is always set so changed this method accordingly.
    // The accountID is not assigned until the object is stored,
    // This eliminates the warning from the original code
    // 
    @Override
    public int hashCode() {
        int hash = 0;
