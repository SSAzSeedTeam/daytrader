...
public class MarketSummaryDataBean implements Serializable
{
	...
	// added on 2018-07-17 (03)
	//	- Added JSON annotation to deserialize inner commection and changed raw type to generic type
	@JsonProperty(value = "topGainers")
    private Collection<QuoteDataBean>     topGainers;        /* Collection of top gaining stocks */

	// added on 2018-07-17 (03)
	//	- Added JSON annotation to deserialize inner commection and changed raw type to generic type
	@JsonProperty(value = "topLosers")
