...
# Output endpoint (hostname:port) of the RDS instance
output "rds_instance_endpoint_portfolios" {
  value = aws_db_instance.portfolios.endpoint
}

# Output endpoint (hostname:port) of the RDS instance
output "rds_instance_endpoint_quotes" {
  value = aws_db_instance.quotes.endpoint
}